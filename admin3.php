...
// ดึงข้อมูลจากตาราง bookings (แทนที่ด้วยชื่อที่ถูกต้อง)
...
<head>
    ...
    <title>หน้า Admin - ประวัติการจองสินค้า</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <div class="container mt-5">
        <h1 class="text-center">ประวัติการจองสินค้า</h1>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='6' class='text-center'>ไม่มีประวัติการจองสินค้า</td></tr>";
                }
                ?>
            </tbody>
        </table>
