...
<body>
    <div class="container-xxl bg-white p-0">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="booking.php" class="nav-item nav-link active">การจอง</a>                   
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/background2.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">การจอง</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">หน้าแรก</a></li>
                            <li class="breadcrumb-item"><a href="#">หน้า</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">การจอง</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
        <link href="sty5.css" rel="stylesheet">
            <h2>จองวันและเวลานำรถเข้าซ่อม</h2>
            <form action="booking.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select id="service" name="service" required>
                        ...
                        <option value="ซ่อมเบรค">ซ่อมเบรค</option>
                        <option value="เปลี่ยนยาง">เปลี่ยนยาง</option>
                        <option value="เปลี่ยนยาง">ถ่ายนำมันเครื่อง</option>
                        <option value="เปลี่ยนยาง">เปลี่ยนแบตเตอรี่</option>
                        <option value="เปลี่ยนยาง">บำรุงรักษาระบบปรับอากาศ</option>
                    </select>
                </div>
                ...
                <a href="booking_list.php" class="btn btn-primary py-3 px-5 mt-2">ดูรายละเอียดการจองทั้งหมด</a>
            </form>
        </div>
        
        <script>
            // ปิดวันที่ก่อนหน้าใน date input
            const dateInput = document.getElementById('date');
            const today = new Date().toISOString().split('T')[0];
            dateInput.setAttribute('min', today);
        
            // ปิดการใช้งานเวลาที่ผ่านมาใน time input ถ้าวันที่เป็นวันนี้
            dateInput.addEventListener('change', function() {
                ...
                if (selectedDate.toDateString() === currentDate.toDateString()) {
                    const currentTime = currentDate.toTimeString().split(':').slice(0, 2).join(':');
