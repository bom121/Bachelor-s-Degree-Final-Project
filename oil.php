...
// ดึงข้อมูลสินค้าน้ำมันจากฐานข้อมูล
$sql = "SELECT * FROM oil";
...
<head>
    ...
    <title>BomAuto - แสดงสินค้าน้ำมัน</title>
...
<body>
    <div class="container mt-5">
        ...
        <h1 class="text-center">สินค้าน้ำมันเครื่องทั้งหมด</h1>
        <div class="row">
            <?php
            if ($result->num_rows > 0) {
                // แสดงข้อมูลสินค้าน้ำมัน
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<input type='hidden' name='image' value='" . $row["image"] . "'>"; // เพิ่ม input นี้เพื่อเก็บ URL รูปภาพ
